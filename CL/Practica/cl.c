...
#endif
{
  ...
  {
  {
    ...
    {
    if ( (LA(1)==PARVAL) ) {
      zzmatch(PARVAL); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
    }
    else {
      if ( (LA(1)==PARREF) ) {
        zzmatch(PARREF); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
      }
...
void
#ifdef __USE_PROTOS
procedure_declaration(AST**_root)
#else
procedure_declaration(_root)
AST **_root;
#endif
{
  zzRULE;
  ...
  params_dec(zzSTR); zzlink(_root, &_sibling, &_tail);
...
void
#ifdef __USE_PROTOS
function_declaration(AST**_root)
#else
function_declaration(_root)
AST **_root;
#endif
{
  zzRULE;
...
#endif
{
  ...
  {
  {
    ...
    if ( (LA(1)==PROCEDURE) ) {
      ...
      procedure_declaration(zzSTR); zzlink(_root, &_sibling, &_tail);
      dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
      l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
      ...
      if ( (LA(1)==FUNCTION) ) {
        ...
        function_declaration(zzSTR); zzlink(_root, &_sibling, &_tail);
        dec_vars(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_dec_blocs(zzSTR); zzlink(_root, &_sibling, &_tail);
        l_instrs(zzSTR); zzlink(_root, &_sibling, &_tail);
        {
      ...
      if ( (setwd3[LA(1)]&0x8) ) {
        {
          ...
          for (;;) {
            ...
            if ( (LA(1)==DOT) ) {
              ...
              if ( (LA(1)==INDOPEN) ) {
                zzmatch(INDOPEN); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
                expression(zzSTR); zzlink(_root, &_sibling, &_tail);
                zzmatch(INDCLOSE);  zzCONSUME;
              }
        ...
        if ( (LA(1)==OPENPAR) ) {
          ...
          fparamlist(zzSTR); zzlink(_root, &_sibling, &_tail);
          zzmatch(CLOSEPAR);  zzCONSUME;
        }
    ...
    while ( (setwd4[LA(1)]&0x8) ) {
      {
        ...
        if ( (LA(1)==EQUAL) ) {
          ...
          if ( (LA(1)==LESSTHAN) ) {
            zzmatch(LESSTHAN); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
          }
          else {
            if ( (LA(1)==GREATERTHAN) ) {
              zzmatch(GREATERTHAN); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
            }
    ...
    while ( (setwd4[LA(1)]&0x80) ) {
      {
        ...
        {
        if ( (LA(1)==PRODUCT) ) {
          zzmatch(PRODUCT); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
        }
        else {
          if ( (LA(1)==DIVISION) ) {
            zzmatch(DIVISION); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
          }
...
#endif
{
  ...
  if ( (setwd5[LA(1)]&0x2) ) {
    ...
    if ( (setwd5[LA(1)]&0x4) ) {
      expression6(zzSTR); zzlink(_root, &_sibling, &_tail);
    }
...
#endif
{
  ...
  {
  if ( (setwd5[LA(1)]&0x10) ) {
    expression7(zzSTR); zzlink(_root, &_sibling, &_tail);
  }
  else {
    if ( (LA(1)==OPENPAR) ) {
      zzmatch(OPENPAR);  zzCONSUME;
...
#endif
{
  ...
  if ( (LA(1)==IDENT) ) {
    ...
    if ( (LA(1)==INTCONST) ) {
      ...
      if ( (LA(1)==TRUECONST) ) {
        zzmatch(TRUECONST); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
      }
      else {
        if ( (LA(1)==FALSECONST) ) {
          zzmatch(FALSECONST); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
        }
