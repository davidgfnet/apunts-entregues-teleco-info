...
ModuleInterface(StartModule)
    // gates:
    Gate(gout, GateDir_Output)
EndInterface

Register_ModuleInterface(StartModule)

//// Sample code:
// class StartModule : public cSimpleModule
// {
//     Module_Class_Members(StartModule,cSimpleModule,16384)
...
//
// void StartModule::activity()
// {
//     // Put code for simple module activity here!
// }
//

ModuleInterface(GenerateRandomNumbers)
    // parameters:
    Parameter(number_of_random_numbers, ParType_Numeric)
    Parameter(num_of_bars, ParType_Numeric)
    Parameter(random_variable, ParType_Numeric)
    // gates:
    Gate(gin, GateDir_Input)
    Gate(gout, GateDir_Output)
EndInterface

Register_ModuleInterface(GenerateRandomNumbers)

//// Sample code:
// class GenerateRandomNumbers : public cSimpleModule
// {
//     Module_Class_Members(GenerateRandomNumbers,cSimpleModule,16384)
//     virtual void activity();
//     // Add you own member functions here!
// };
//
...
//
// void GenerateRandomNumbers::activity()
// {
//     // Put code for simple module activity here!
// }
//

ModuleInterface(Sink)
    // gates:
    Gate(gin, GateDir_Input)
EndInterface

Register_ModuleInterface(Sink)
