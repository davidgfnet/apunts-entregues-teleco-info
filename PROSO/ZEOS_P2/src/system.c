  ...
  main(void) 
{
  ...
  init_kheap(); // Now esp is set to task0 PCB, we can use all the avaliable kernel memory
  ...
  /* Set up the File System and the FAT disk */
  initZeOSFat();

  /* Set up the file descriptors structures */
  InitializeFD();
