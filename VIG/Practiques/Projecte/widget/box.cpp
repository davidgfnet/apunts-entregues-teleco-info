...
std::vector<Point> Box::getPoints() const {
  std::vector<Point> vec;

  vec.push_back(Point(minb.x,minb.y,maxb.z));
  vec.push_back(Point(minb.x,minb.y,minb.z));

  vec.push_back(Point(minb.x,maxb.y,maxb.z));
  vec.push_back(Point(minb.x,maxb.y,minb.z));

  vec.push_back(Point(maxb.x,minb.y,maxb.z));
  vec.push_back(Point(maxb.x,minb.y,minb.z));

  vec.push_back(Point(maxb.x,maxb.y,maxb.z));
  vec.push_back(Point(maxb.x,maxb.y,minb.z));
