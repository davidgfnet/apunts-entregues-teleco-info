...
**
** Created: Fri Dec 17 22:38:09 2010
...
static const char qt_meta_stringdata_MaterialWidget[] = {
    ...
    "MakeInvisible(float*)\0"
    "ar,ag,ab,dr,dg,db,sr,sg,sb,s\0"
...
int MaterialWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: MakeInvisible((*reinterpret_cast< float*(*)>(_a[1]))); break;
        case 2: MakeVisible((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3])),(*reinterpret_cast< float(*)>(_a[4])),(*reinterpret_cast< float(*)>(_a[5])),(*reinterpret_cast< float(*)>(_a[6])),(*reinterpret_cast< float(*)>(_a[7])),(*reinterpret_cast< float(*)>(_a[8])),(*reinterpret_cast< float(*)>(_a[9])),(*reinterpret_cast< float(*)>(_a[10]))); break;
        case 3: ValuesUpdated(); break;
        case 4: ComboChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: Aplica(); break;
        case 6: Revert(); break;
        default: ;
        }
