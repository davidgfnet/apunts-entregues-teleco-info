...
**
** Created: Thu Dec 2 13:36:08 2010
...
static const char qt_meta_stringdata_ColorWidget[] = {
    "ColorWidget\0\0valueChanged()\0changedRed(int)\0"
    "changedGreen(int)\0changedBlue(int)\0"
};
...
int ColorWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: changedRed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: changedGreen((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: changedBlue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
