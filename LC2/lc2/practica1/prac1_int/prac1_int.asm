...
;* Date/Time created: Tue Feb 05 13:35:42 2008                                *
;******************************************************************************
...
;	C:\CCStudio_v3.1\c6000\cgtools\bin\acp6x.exe -@C:\DOCUME~1\will\CONFIG~1\Temp\TI80012 
	.sect	".text"
	.global	_c_int11
...
DW$7	.dwtag  DW_TAG_subprogram, DW_AT_name("c_int11"), DW_AT_symbol_name("_c_int11")
	...
	.dwattr DW$7, DW_AT_begin_file("prac1_int.c")
	.dwattr DW$7, DW_AT_begin_line(0x07)
	.dwattr DW$7, DW_AT_begin_column(0x10)
	.dwpsn	"prac1_int.c",8,1

	.dwfde DW$CIE
;----------------------------------------------------------------------
;   7 | interrupt void c_int11()         //rutina de servicio de interrupcion  
;----------------------------------------------------------------------
...
;** --------------------------------------------------------------------------*
	...
	.dwcfa	0x80, 0, 18
           ...
           NOP             2
	.dwcfa	0x80, 8, 19
	.dwpsn	"prac1_int.c",9,2
;----------------------------------------------------------------------
;   9 | input_data = input_left_sample();  // señan del canal izquierdo de line
;     |  in                                                                    
;----------------------------------------------------------------------
           CALL    .S1     _input_left_sample ; |9| 
           MVKL    .S2     RL0,B3            ; |9| 
           MVKH    .S2     RL0,B3            ; |9| 
           NOP             3
RL0:       ; CALL OCCURS {_input_left_sample}  ; |9| 
           MVKL    .S2     _input_data,B4    ; |9| 

           MVKH    .S2     _input_data,B4    ; |9| 
||         MV      .L2X    A4,B5             ; |9| 

           STW     .D2T2   B5,*B4            ; |9| 
           NOP             2
	.dwpsn	"prac1_int.c",10,3
;----------------------------------------------------------------------
;  10 | output_sample(output_data);                                            
;----------------------------------------------------------------------
           MVKL    .S1     _output_data,A3   ; |10| 

           CALL    .S2     _output_sample    ; |10| 
||         MVKH    .S1     _output_data,A3   ; |10| 

           LDW     .D1T1   *A3,A4            ; |10| 
           MVKL    .S2     RL1,B3            ; |10| 
           MVKH    .S2     RL1,B3            ; |10| 
           NOP             2
RL1:       ; CALL OCCURS {_output_sample}    ; |10| 
	.dwpsn	"prac1_int.c",11,2
;----------------------------------------------------------------------
;  11 | return;                                                                
;----------------------------------------------------------------------
	.dwpsn	"prac1_int.c",12,1
           LDDW    .D2T2   *+SP(80),B7:B6    ; |12| 
           NOP             4
	.dwcfa	0xc0, 22
	.dwcfa	0xc0, 23
           LDDW    .D2T2   *+SP(72),B5:B4    ; |12| 
           NOP             4
	.dwcfa	0xc0, 20
	.dwcfa	0xc0, 21
           LDDW    .D2T2   *+SP(64),B3:B2    ; |12| 
           NOP             4
	.dwcfa	0xc0, 18
	.dwcfa	0xc0, 19
           LDDW    .D2T2   *+SP(56),B1:B0    ; |12| 
           NOP             4
	.dwcfa	0xc0, 16
	.dwcfa	0xc0, 17
           LDW     .D2T2   *+SP(52),B8       ; |12| 
           NOP             4
	.dwcfa	0xc0, 24
           LDW     .D2T1   *+SP(48),A9       ; |12| 
           NOP             4
	.dwcfa	0xc0, 9
           LDDW    .D2T1   *+SP(40),A7:A6    ; |12| 
           NOP             4
	.dwcfa	0xc0, 6
	.dwcfa	0xc0, 7
           LDDW    .D2T1   *+SP(32),A5:A4    ; |12| 
           NOP             4
	.dwcfa	0xc0, 4
	.dwcfa	0xc0, 5
           LDDW    .D2T1   *+SP(24),A3:A2    ; |12| 
           NOP             4
	.dwcfa	0xc0, 2
	.dwcfa	0xc0, 3
           LDDW    .D2T1   *+SP(16),A1:A0    ; |12| 
           NOP             4
	.dwcfa	0xc0, 0
	.dwcfa	0xc0, 1
           LDW     .D2T1   *+SP(12),A8       ; |12| 
           NOP             4
	.dwcfa	0xc0, 8
           LDW     .D2T2   *++SP(88),B9      ; |12| 
           NOP             4
	.dwcfa	0xc0, 25
	.dwcfa	0x0e, 0
           RET     .S2     IRP               ; |12| 
           NOP             5
           ; BRANCH OCCURS {IRP}             ; |12| 
	.dwattr DW$7, DW_AT_end_file("prac1_int.c")
	.dwattr DW$7, DW_AT_end_line(0x0c)
...
;** --------------------------------------------------------------------------*
	...
	.dwcfa	0x0e, 8
	.dwcfa	0x80, 19, 0
	.dwpsn	"prac1_int.c",16,3
;----------------------------------------------------------------------
;  16 | comm_intr();                   //inicio DSK, codec, McBSP usando interr
;     | upciones                                                               
;----------------------------------------------------------------------
           CALL    .S1     _comm_intr        ; |16| 
           MVKL    .S2     RL2,B3            ; |16| 
           MVKH    .S2     RL2,B3            ; |16| 
           NOP             3
RL2:       ; CALL OCCURS {_comm_intr}        ; |16| 
	.dwpsn	"prac1_int.c",17,9
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  20 | output_data = input_data;                                              
;----------------------------------------------------------------------
           MVKL    .S1     _input_data,A3    ; |20| 
           MVKH    .S1     _input_data,A3    ; |20| 
           LDW     .D1T1   *A3,A3            ; |20| 
           MVKL    .S2     _output_data,B4   ; |20| 
           MVKH    .S2     _output_data,B4   ; |20| 
           NOP             2
           STW     .D2T1   A3,*B4            ; |20| 
           NOP             2
	.dwpsn	"prac1_int.c",17,9
...
DW$9	.dwtag  DW_TAG_loop
	.dwattr DW$9, DW_AT_name("C:\CCStudio_v3.1\MyProjects\pepe\definitiu\practiques_noves\practica1\prac1_int\prac1_int.asm:L1:1:1202214942")
	.dwattr DW$9, DW_AT_begin_file("prac1_int.c")
	.dwattr DW$9, DW_AT_begin_line(0x11)
	.dwattr DW$9, DW_AT_end_line(0x15)
DW$10	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$8, DW_AT_end_line(0x16)
