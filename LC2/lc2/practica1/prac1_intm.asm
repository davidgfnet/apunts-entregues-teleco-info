...
;* Date/Time created: Mon Feb 28 11:16:20 2011                                *
;******************************************************************************
...
DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr DW$CU, DW_AT_name("prac1_intm.c")
...
;	C:\CCStudio_v3.1\c6000\cgtools\bin\acp6x.exe -@C:\DOCUME~1\lc2125\CONFIG~1\Temp\TI46412 
	.sect	".text"
	.global	_c_int11
...
RL1:       ; CALL OCCURS {_output_sample}    ; |11| 
	.dwpsn	"prac1_intm.c",12,2
;----------------------------------------------------------------------
;  12 | return;                                                                
;----------------------------------------------------------------------
	.dwpsn	"prac1_intm.c",13,1
	...
	.dwattr DW$8, DW_AT_end_file("prac1_intm.c")
...
DW$10	.dwtag  DW_TAG_loop
	.dwattr DW$10, DW_AT_name("C:\Documents and Settings\lc2125\Escritorio\practica1\prac1_intm.asm:L1:1:1298888180")
	.dwattr DW$10, DW_AT_begin_file("prac1_intm.c")
...
DW$11	.dwtag  DW_TAG_loop_range
	...
	.dwattr DW$9, DW_AT_end_file("prac1_intm.c")
